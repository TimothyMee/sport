						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
						        <a href= <?php echo e(route('main_content_editor')); ?> ><button type="button" class="btn btn-default" data-dismiss="" style="float:left; margin-right:20px;">Close</button></a>
						        
						        <!--here am going to create a hidden  form and pass the variables in a new function  -->
									<form method="post" action= <?php echo e(route('main_Preview')); ?>>
